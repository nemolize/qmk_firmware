...
#define MOUSEKEY_CURSOR_FORCE 480
#define MOUSEKEY_CURSOR_MASS 1
#define MOUSEKEY_CURSOR_FRICTION 38
#define MOUSEKEY_WHEEL_FORCE 500
#define MOUSEKEY_WHEEL_MASS .3
#define MOUSEKEY_WHEEL_FRICTION (MOUSEKEY_WHEEL_FORCE*1.13)
